...
namespace mhxy.Extensions {
    ...
    public static class StringExtensions {
        ...
        public static byte[] ToHexBytes(this string hexString) {
            hexString = string.IsNullOrEmpty(hexString) ? "" : hexString.Replace(" ", "");
        ...
        public static string GetChineseSpell(this string cnString) {
            ...
            if (!cnString.IsMatch(@"[\u4E00-\u9FA5]"))
                throw new ArgumentException(Resources.ParamIsNotCnString, nameof(cnString));
            ...
            if (bytes.Length > 1) {
                ...
                for (var i = 0; i < 26; i++) {
                    ...
                    if (areacode[i] <= code && code < max)
                        return Encoding.Default.GetString(new[] {(byte) (97 + i)}).ToUpper();
                }
                return "*";
            }
